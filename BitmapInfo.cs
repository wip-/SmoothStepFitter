...
namespace SmoothStepFitter
{
    ...
    public class BitmapInfo
    {
        ...
        {
            return Helpers.HasAlphaChannel(PixelFormat);
        }
        ...
        public BitmapInfo(Bitmap bitmap, CopyData copyData = CopyData.True)
        {
            ...
            BytesPerPixel = Helpers.GetBytesPerPixel(bitmap.PixelFormat);
        ...
        public BitmapInfo(int width, int height, PixelFormat pixelFormat)
        {
            ...
            BitsPerPixel = Image.GetPixelFormatSize(PixelFormat);
            BytesPerPixel = Helpers.GetBytesPerPixel(PixelFormat);
        ...
        public Color GetPixelColor(int x, int y)
        {
            ...
            if (PixelFormat == PixelFormat.Format8bppIndexed)
            {
                ...
                return (Color)palette.Entries[colorIndex];
            }
